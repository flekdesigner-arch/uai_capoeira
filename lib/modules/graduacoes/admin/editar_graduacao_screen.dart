...
class _EditarGraduacaoScreenState extends State<EditarGraduacaoScreen> {
  ...
  Future<void> _loadGraduacaoData() async {
    ...
    try {
      ...
      if (mounted) {
        _showSnack('Erro ao carregar graduação: $e', context.uai.error);
      }
    } finally {
  ...
  Future<void> _saveGraduacao() async {
    ...
    try {
      ...
      if (mounted) {
        _showSnack('Graduação salva com sucesso!', context.uai.success);
  ...
  InputDecoration _inputDecoration({
    ...
    return InputDecoration(
      ...
      prefixIcon: Padding(
        padding: EdgeInsets.only(bottom: multiline ? 72 : 0),
        child: Icon(icon, color: accent),
      ),
      filled: true,
      fillColor: t.cardAlt,
      ...
      errorBorder: OutlineInputBorder(
        borderRadius: BorderRadius.circular(t.inputRadius),
        borderSide: BorderSide(color: t.error.withOpacity(0.75)),
      ),
