...
class _AvaliacaoAlunosTurmaScreenState extends State<AvaliacaoAlunosTurmaScreen> {
  ...
  Future<void> _carregarTudo() async {
    ...
    try {
      ...
      if (!mounted) return;
      setState(() => _isLoading = false);
      _mostrarSnack('Erro ao carregar avaliações: $e', context.uai.error);
    }
  }
  ...
  Future<void> _trocarCiclo(Map<String, dynamic> ciclo) async {
    ...
    try {
      ...
      _mostrarSnack('Erro ao trocar ciclo: $e', context.uai.error);
    }
  ...
  Future<void> _criarOuAbrirCiclo(int mes, int ano) async {
    ...
    try {
      ...
      if (!doc.exists) {
        ...
        _mostrarSnack('Ciclo criado com sucesso!', context.uai.success);
      } else {
        _mostrarSnack('Ciclo já existia, abrindo avaliação.', context.uai.info);
      }
      ...
      _mostrarSnack('Erro ao criar ciclo: $e', context.uai.error);
    } finally {
  ...
  Future<void> _abrirSeletorCiclo() async {
    ...
    if (_ciclos.isEmpty) {
      _mostrarSnack('Nenhum ciclo encontrado.', context.uai.warning);
      return;
    }
  ...
  Future<void> _alternarStatusCiclo() async {
    ...
    try {
      ...
      _mostrarSnack(
        ...
        novoStatus == 'finalizado' ? context.uai.warning : context.uai.success,
      );
    } catch (e) {
      _mostrarSnack('Erro ao alterar status do ciclo: $e', context.uai.error);
    }
  }
  ...
  Future<void> _salvarAvaliacao(
    ...
    try {
      ...
      _mostrarSnack('Erro ao salvar avaliação: $e', context.uai.error);
    }
  }
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          ...
          focusedBorder: OutlineInputBorder(
            borderRadius: BorderRadius.circular(18),
            borderSide: BorderSide(color: context.uai.associacao, width: 1.4),
          ),
        ),
      ),
    );
          ...
          InkWell(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                ...
                borderRadius: BorderRadius.circular(16),
                border: Border.all(color: context.uai.card.withOpacity(0.13)),
              ),
              child: Row(
                children: [
  ...
  Widget _headerMetric(String valor, String label, IconData icon) {
    return Container(
      ...
      child: Column(
        children: [
          Icon(icon, color: _onCard(context), size: 18),
          SizedBox(height: 4),
          Text(
            valor,
            style: TextStyle(
        ...
        itemBuilder: (context, index) {
          ...
          return Padding(
            ...
            child: ChoiceChip(
              ...
              selected: ativo,
              selectedColor: context.uai.associacao,
                    ...
                    Row(
                      children: [
                        _miniChip(
                          ...
                          temAvaliacao ? _corNota(nota) : context.uai.warning,
                        ),
                        SizedBox(width: 7),
                        Expanded(
                          child: Text(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  ...
                  style: TextStyle(color: _onCardMuted(context), height: 1.35),
                  textAlign: TextAlign.center,
                ),
              ],
            ),
    ...
    return Padding(
      ...
      child: TextField(
        ...
        decoration: InputDecoration(
          labelText: label,
          hintText: hint,
          prefixIcon: Icon(icon, color: context.uai.associacao),
          filled: true,
          fillColor: context.uai.background,
              ...
              child: ListView(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      gradient: LinearGradient(
                        colors: [context.uai.associacao, _corNota(_media)],
                        begin: Alignment.topLeft,
                        end: Alignment.bottomRight,
                      ),
