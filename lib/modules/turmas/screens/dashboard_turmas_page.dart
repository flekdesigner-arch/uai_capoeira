...
class _DashboardTurmasPageState extends State<DashboardTurmasPage>
  ...
  // Cache
  static int _CACHE_VALIDADE_HORAS = 1;
  static int _CACHE_VALIDADE_MINUTOS = _CACHE_VALIDADE_HORAS * 60;
  static int _CACHE_VALIDADE_MS = _CACHE_VALIDADE_HORAS * 60 * 60 * 1000;
  ...
  void _iniciarTimerCache() {
    _timerCache = Timer.periodic(Duration(minutes: 30), (_) {
  ...
  Color _colorFromHexSeguro(dynamic hexColor) {
    if (hexColor == null) return context.uai.textMuted;
    ...
    if (hex.length != 6) return context.uai.textMuted;
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Row(
              children: [
                Icon(Icons.speed_rounded, color: context.uai.card),
                SizedBox(width: 8),
                Expanded(
                  child: Text(
                    recalcularTudo
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(
            content: Row(
              children: [
                Icon(Icons.error, color: context.uai.card),
                SizedBox(width: 8),
  ...
  Color _corNotaDestaque(double nota) {
    if (nota >= 9) return context.uai.success;
    if (nota >= 8) return context.uai.success;
    if (nota >= 7) return context.uai.info;
    if (nota >= 6) return context.uai.warning;
  ...
  Color _hexToColor(String hex) {
    ...
    Color color = context.uai.textMuted;
    if (clean.length == 6)
  ...
  Color _corTextoChipQuantidade(Color corBase) {
    ...
    if (corBase.computeLuminance() > 0.70) {
      return context.uai.textPrimary;
    }
  ...
  Widget _buildHeaderMetricas() {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: context.uai.primary.withOpacity(0.35),
            blurRadius: 18,
            offset: Offset(0, 8),
          ),
        ],
          ...
          children: [
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        ...
                        style: TextStyle(
                          color: _onGradient().withOpacity(0.72),
                          fontSize: 12,
                        ),
                      ),
                    ],
            ...
            ClipRRect(
              ...
              child: LinearProgressIndicator(
                ...
                backgroundColor: context.uai.card.withOpacity(0.18),
                valueColor: AlwaysStoppedAnimation<Color>(context.uai.warning),
                minHeight: 8,
              ),
            ),
          ],
  ...
  Widget _metricHeader(IconData icon, String valor, String label, Color cor) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: _onGradient().withOpacity(0.12),
        borderRadius: BorderRadius.circular(18),
        border: Border.all(color: _onGradient().withOpacity(0.12)),
      ),
      child: Column(
        children: [
      ...
      child: AnimatedScale(
        ...
        child: ChoiceChip(
          ...
          shape: RoundedRectangleBorder(
            borderRadius: BorderRadius.circular(18),
            side: BorderSide(
              color: ativo ? cor.withOpacity(0.05) : context.uai.border,
            ),
          ),
        ),
      ),
  ...
  Future<Uint8List> _gerarImagemRankingAlunoDestaque() async {
    ...
    canvas.drawCircle(
      Offset(95, 110),
      140,
      Paint()..color = Color(0xFFB91C1C).withOpacity(0.045),
    );
    canvas.drawCircle(
      Offset(width - 110, 250),
      170,
      Paint()..color = Color(0xFFF59E0B).withOpacity(0.075),
    );
    canvas.drawCircle(
      Offset(width - 120, height - 150),
      140,
      Paint()..color = Color(0xFF7C3AED).withOpacity(0.045),
    );

    final mainCard = RRect.fromRectAndRadius(
      Rect.fromLTWH(42, 42, width - 84, height - 84),
      Radius.circular(48),
    );
    ...
    final logoBox = RRect.fromRectAndRadius(
      Rect.fromLTWH(82, 78, 150, 118),
      Radius.circular(26),
    );
    canvas.drawRRect(logoBox, Paint()..color = Color(0xFFFAFAFA));
    canvas.drawRRect(
      logoBox,
      Paint()
        ..style = PaintingStyle.stroke
    ...
    final periodoBox = RRect.fromRectAndRadius(
      Rect.fromLTWH(260, 166, 520, 42),
      Radius.circular(21),
    );
    canvas.drawRRect(periodoBox, Paint()..color = Color(0xFFF3F4F6));
    _drawCanvasText(
      canvas,
    ...
    final formulaBox = RRect.fromRectAndRadius(
      Rect.fromLTWH(790, 166, 190, 42),
      Radius.circular(21),
    );
    canvas.drawRRect(formulaBox, Paint()..color = Color(0xFFFFF7ED));
    _drawCanvasText(
      canvas,
      '60% + 40%',
      x: 808,
    ...
    final criteriosCard = RRect.fromRectAndRadius(
      Rect.fromLTWH(82, 236, width - 164, 194),
      Radius.circular(30),
    );
    canvas.drawRRect(criteriosCard, Paint()..color = Color(0xFFF9FAFB));
    canvas.drawRRect(
      criteriosCard,
      Paint()
        ..style = PaintingStyle.stroke
    ...
    if (top3.isNotEmpty) {
      ...
      final champ = RRect.fromRectAndRadius(
        Rect.fromLTWH(82, 526, width - 164, 228),
        Radius.circular(36),
      );
      canvas.drawRRect(champ, Paint()..color = Color(0xFFFFFBEB));
      canvas.drawRRect(
        champ,
        Paint()
          ..style = PaintingStyle.stroke
      ...
      _drawCanvasTiposAulaBox(
        ...
        rect: Rect.fromLTWH(650, 604, 250, 86),
        fontSize: 13,
      );

      final scoreBox = RRect.fromRectAndRadius(
        Rect.fromLTWH(width - 252, 590, 124, 104),
        Radius.circular(28),
      );
    ...
    for (int i = 0; i < demais.length; i++) {
      ...
      canvas.drawRRect(rankBg, Paint()..color = Color(0xFF111827));
      _drawCanvasText(
        canvas,
        '$rank',
        x: 108,
                ...
                children: [
                  ...
                  ClipRRect(
                    ...
                    child: LinearProgressIndicator(
                      ...
                      backgroundColor: context.uai.warning.withOpacity(0.10),
                    ),
                  ),
                  SizedBox(height: 12),
                  Text(
  ...
  Future<Uint8List?> _baixarBytesRankingUrl(String? url) async {
    ...
    try {
      client = HttpClient();
      client.connectionTimeout = Duration(seconds: 6);
      final request = await client.getUrl(Uri.parse(url));
      final response = await request.close();
      if (response.statusCode < 200 || response.statusCode >= 300) return null;
      final builder = BytesBuilder(copy: false);
  ...
  pw.Widget _pdfInfoLinha(List<String> itens, {
    ...
    final resolvedColor = color ?? PdfColor.fromInt(0xFF4B5563);
  ...
  DateTime? _fimPeriodoRankingPdf() {
    ...
    switch (filtroTemporalFrequencia) {
      case 'Semana':
        return _inicioSemanaAtual(now).add(Duration(days: 7));
      case 'Mês':
  ...
  pw.Widget _pdfTiposAulaBox(
    ...
    return pw.Container(
      width: width,
      height: height,
      padding: pw.EdgeInsets.symmetric(horizontal: 8, vertical: 4.5),
      decoration: pw.BoxDecoration(
  ...
  pw.Widget _pdfLinhaRanking(
    ...
    return pw.Container(
      height: 49,
      margin: pw.EdgeInsets.only(bottom: 3.7),
      padding: pw.EdgeInsets.symmetric(horizontal: 8.5, vertical: 4.5),
      decoration: pw.BoxDecoration(
        color: PdfColors.white,
  ...
  Future<void> _compartilharPdfRankingAlunoDestaque() async {
    if (_alunosDestaque.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Nenhum aluno disponível para gerar o PDF.'),
  ...
  Future<void> _compartilharPdfCompletoRankingAlunoDestaque() async {
    if (_alunosDestaque.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Nenhum aluno disponível para gerar o PDF completo.'),
          backgroundColor: context.uai.warning,
        ),
      );
      return;
  ...
  Future<void> _compartilharRankingAlunoDestaque() async {
    if (_alunosDestaque.isEmpty) {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text('Nenhum aluno disponível para gerar o ranking.'),
          backgroundColor: context.uai.warning,
        ),
      );
      return;
      ...
      children: [
        Container(
          ...
          decoration: BoxDecoration(
            ...
            border: Border.all(color: context.uai.warning.withOpacity(0.18)),
            boxShadow: [
              BoxShadow(
                color: Colors.black.withOpacity(0.08),
                blurRadius: 12,
                    ...
                    child: Column(
                      children: [
                        ...
                        Text(
                          'média',
                          style: TextStyle(
                            color: context.uai.warning.withOpacity(0.75),
                            fontSize: 9,
                            fontWeight: FontWeight.w800,
                          ),
                        ),
  ...
  Widget _destaqueInfoSlim(String valor, String label, IconData icon, Color color) {
    return Container(
      ...
      child: Row(
        ...
        children: [
          Icon(icon, color: _ensureVisible(color, context.uai.card), size: 15),
          SizedBox(width: 5),
          Flexible(
            child: RichText(
              maxLines: 1,
  ...
  Widget _destaqueResumoCard(String valor, String label, IconData icon) {
    return Container(
      ...
      decoration: BoxDecoration(
        color: context.uai.card.withOpacity(0.13),
        borderRadius: BorderRadius.circular(16),
        border: Border.all(color: context.uai.card.withOpacity(0.12)),
      ),
      child: Column(
        children: [
          Icon(icon, color: context.uai.textPrimary, size: 20),
          SizedBox(height: 4),
          Text(
            valor,
    ...
    return Expanded(
      child: GestureDetector(
        ...
        child: AnimatedContainer(
          ...
          decoration: BoxDecoration(
            color: ativo ? context.uai.info : Colors.transparent,
                ...
                BarChartData(
                  ...
                  barTouchData: BarTouchData(
                    ...
                    touchTooltipData: BarTouchTooltipData(
                      getTooltipColor: (g) => context.uai.info,
                  ...
                  borderData: FlBorderData(
                    ...
                    border: Border(
                      bottom: BorderSide(color: context.uai.border),
                      left: BorderSide(color: context.uai.border),
                    ),
                  ),
                  gridData: FlGridData(
                    show: true,
                    ...
                    return BarChartGroupData(
                      ...
                      barRods: [
                        BarChartRodData(
                          ...
                          gradient: LinearGradient(
                            colors: [
                              context.uai.info.withOpacity(0.78),
                              context.uai.info.withOpacity(0.55),
                            ],
  ...
  Widget _buildGraduacaoCard({
    ...
    final Color cor = isSem ? context.uai.textMuted : _hexToColor(cor1);
        ...
        child: Theme(
          ...
          child: ExpansionTile(
            ...
            leading: Container(
              ...
              decoration: BoxDecoration(
                color: isSem ? context.uai.cardAlt : cor.withOpacity(0.08),
                borderRadius: BorderRadius.circular(14),
                border: Border.all(color: cor.withOpacity(0.22)),
              ),
              child: isSem
  ...
  Widget _buildCordaWidget(String nomeGraduacao) {
    if (nomeGraduacao == 'SEM GRADUAÇÃO' || _svgContent == null) {
      return SizedBox(width: 40, height: 60);
    }
  ...
  Widget _btnSexo(
    ...
    child: AnimatedContainer(
      ...
      child: Column(
        children: [
          Icon(i, color: ativo ? c : context.uai.textSecondary, size: 22),
          SizedBox(height: 4),
          Text(
            t,
            style: TextStyle(
  ...
  Widget _buildRankingAlunoTile(
    ...
    final Color medalColor = posicao == 1
        ...
        : posicao == 3
        ? context.uai.warning.withOpacity(0.70)
        : corBase;
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text(
                    graduacao,
                    style: TextStyle(fontSize: 10, color: _onCardMuted()),
                    maxLines: 1,
                    overflow: TextOverflow.ellipsis,
                  ),
                ],
  ...
  Widget _buildListaTop5() {
    if (_alunosFrequentes.isEmpty) return SizedBox.shrink();
    return Container(
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(18),
        boxShadow: [
  ...
  Widget _buildListaCompleta() {
    if (_alunosOrdenadosPorFrequencia.isEmpty) return SizedBox.shrink();
  ...
  Widget _emptyChart(String msg) => Center(
    child: Padding(
      ...
      child: Column(
        children: [
          Icon(Icons.show_chart, size: 48, color: context.uai.textMuted),
          SizedBox(height: 12),
          Text(msg, style: TextStyle(color: context.uai.textMuted)),
        ],
      ),
    ),
  );
  ...
  Widget _buildEmptyScreen() => Center(
    child: Padding(
      ...
      child: Column(
        children: [
          Icon(Icons.people_outline, size: 64, color: context.uai.textMuted),
          SizedBox(height: 16),
...
class _DetalheFrequenciaAlunoDashboardDialogState
  ...
  Widget _buildItem(Map<String, dynamic> item) {
    ...
    final color = presente ? context.uai.success : context.uai.error;
    ...
    return Center(
      child: Padding(
        ...
        child: Column(
          mainAxisAlignment: MainAxisAlignment.center,
          children: [
            Icon(Icons.inbox_rounded, color: context.uai.border, size: 82),
            SizedBox(height: 12),
            Text(
              _aba == 2
