          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text('Escolher nova foto da galeria'),
                subtitle: Text('Selecionar outra imagem do celular'),
                onTap: () {
                  Navigator.of(context).pop();
              ...
              ListTile(
                ...
                title: Text('Tirar nova foto com a câmera'),
...
'''.trim();
    ...
    await showDialog<void>(
      ...
      builder: (context) {
        return AlertDialog(
          ...
          title: Row(
            children: [
              Icon(Icons.check_circle, color: context.uai.success, size: 30),
              SizedBox(width: 12),
              Expanded(
                child: Text(
                  'Cadastro realizado!',
      ...
      children: [
        ...
        if (!_fotoCarregada && !temFotoAtual)
          Text(
            ...
            style: TextStyle(color: context.uai.error, fontSize: 12),
          ),
      ],
    );
  }
        ...
        child: Column(
          ...
          children: [
            ...
            if (nivel.isNotEmpty) ...[
              ...
              Row(
                children: [
                  Icon(Icons.star, size: 16, color: context.uai.textSecondary),
                  SizedBox(width: 6),
                  Text(
                    nivel,
                    style: TextStyle(fontSize: 12, color: context.uai.textSecondary),
            ...
            if (_turmaCheia) ...[
              ...
              Row(
                children: [
                  Icon(Icons.warning, size: 16, color: context.uai.error),
                  SizedBox(width: 6),
                  Text(
                    'TURMA CHEIA',
                    style: TextStyle(
  ...
  Widget _buildStatusContainer() => Container(
    ...
    decoration: BoxDecoration(
      ...
      borderRadius: BorderRadius.circular(8),
      border: Border.all(color: context.uai.success.withOpacity(0.30)),
    ),
    child: Row(
      children: [
        Icon(Icons.check_circle, color: context.uai.success, size: 20),
        SizedBox(width: 8),
        Text(
          'Status: ATIVO(A)',
