...
class AlunoSnapshotModel {
  ...
  factory AlunoSnapshotModel.fromMap(Map<String, dynamic> map, {String? id}) {
    ...
    return AlunoSnapshotModel(
      ...
      destaque_score_total: _toDouble(map['destaque_score_total']),
      destaque_score_semana: _toDouble(map['destaque_score_semana']),
      destaque_score_mes: _toDouble(map['destaque_score_mes']),
      destaque_score_por_ano: _toDouble(map['destaque_score_por_ano']),
